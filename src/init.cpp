    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Litecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  novashared [options]                     " + "\n" +
                  "  novashared [options] <command> [params]  " + _("Send command to -server or novashared") + "\n" +
                  "  novashared [options] help                " + _("List commands") + "\n" +
                  "  novashared [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "novashare:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: novashare.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: novashared.pid)") + "\n" +
