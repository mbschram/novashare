...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("novashare"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("novashare://"))
    {
        uri.replace(0, 11, "novashare:");
    }
...
{
    return GetAutostartDir() / "novashare.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Litecoin-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  novashare-qt [" + tr("command-line options") + "]                     " + "\n";
